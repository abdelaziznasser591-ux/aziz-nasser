...
export const WhatsAppButton = () => {
  const handleClick = () => {
    window.open('https://wa.me/96176779566', '_blank');
  };
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-full mr-3 px-3 py-2 bg-white rounded-lg shadow-lg text-gray-800 text-sm font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
        Order on WhatsApp
      </span>
    </button>
  );
